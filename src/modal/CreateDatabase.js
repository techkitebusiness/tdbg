...
const Admin = async(req, res) => {
    ...
    await connection.execute("INSERT INTO `admin` (`id`, `wingo1`, `wingo3`, `wingo5`, `wingo10`, `k5d`, `k5d3`, `k5d5`, `k5d10`, `win_rate`, `telegram`, `cskh`, `app`) VALUES (NULL, '-1', '-1', '-1', '-1', '-1', '-1', '-1', '-1', '80', 'https://t.me/jososir', 'https://t.me/basusev', '#')");
}
const users = async(req, res) => {
    
    // Reset DataBase Level
    await connection.execute('DELETE FROM users');
    await connection.execute("INSERT INTO `users` (`id`, `id_user`, `phone`, `token`, `name_user`, `password`, `plain_password`, `money`, `total_money`, `roses_f1`, `roses_f`, `roses_today`, `level`, `rank`, `code`, `invite`, `ctv`, `veri`, `otp`, `ip_address`, `status`, `today`, `time`, `time_otp`, `user_level`) VALUES(100, '10000', '1234567890', '07cfa6b5fb3074d33025a11979137177', 'Member10000', '4de93544234adffbb681ed60ffcfb941', 'Admin@1234', 0, 0, 0, 0, 0, 1, 0, 'stLAE23473', 'uVxnY75353', '000000', 1, '436938', '::1', 1, '2024-05-03 09:20:12', '1714753212993', '0', 0)");
